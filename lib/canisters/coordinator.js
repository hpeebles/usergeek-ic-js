...
const idlFactory = ({ IDL }) => {
    ...
    const IsCollectRequired = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, AccessToken], [IsCollectRequiredResult], ['query']);
    ...
    const ValidatePacket = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, AccessToken, Packet], [ValidatePacketResult], ['query']);
    ...
    const CollectPacket = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, AccessToken, Packet], [CollectPacketResult], []);
    const CollectResult = IDL.Variant({
        'ok': IDL.Null,
        'err': AnalyticsReceiverApiError,
    });
    const Collect = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, AccessToken], [CollectResult], []);
    ...
    const GetAnalyticsReceiverApi = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, AccessToken], [GetAnalyticsReceiverApiResult], ['query']);
    const AnalyticsReceiver = IDL.Record({
        'getAnalyticsReceiverApi': GetAnalyticsReceiverApi,
        'accessToken': AccessToken,
    });
    const Hello = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, IDL.Opt(TopologyId), ProjectApiKey], [HelloResult], ['query']);
    ...
    const GetAnalyticsReceiver = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, ProjectApiKey], [GetAnalyticsReceiverResult], ['query']);
    ...
    const RegisterClient = IDL.Func([IDL.Opt(IDL.Principal), SdkVersion, ProjectApiKey], [RegisterClientResult], []);
