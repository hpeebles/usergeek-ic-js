...
import { createErrResult, createOkResult, hasOwnProperty, isOk, UsergeekUtils, warn, log } from "../utils";
    ...
    function Tracker(apiKey, clientPrincipal, initialConfiguration, debugConfiguration) {
        ...
        this.logSession = function () {
            try {
                ...
                _this.logReport(UsergeekUtils.getCurrentTime(), report);
            }
            catch (e) {
                //nop
            }
        ...
        this.logReport = function (timeMillis, reportContent) {
            ...
            if (!putSuccess) {
                if ((_c = _this.debugConfiguration) === null || _c === void 0 ? void 0 : _c.loggerError) {
                    (_d = _this.debugConfiguration) === null || _d === void 0 ? void 0 : _d.loggerError("Unable to store data in localStorage. Seems that there is no space left... Will try to remove ".concat(_this.configuration.removeReportsPercentWhenFull, "% of oldest events"));
                }
                ...
                if (tryToFreeSpaceSuccess) {
                    if ((_e = _this.debugConfiguration) === null || _e === void 0 ? void 0 : _e.loggerWarn) {
                        (_f = _this.debugConfiguration) === null || _f === void 0 ? void 0 : _f.loggerWarn("Number of reports removed: ".concat(removeCount, ". Actual reports: ").concat(_this.reportsStorage.getReportsCount()));
                    }
                    ...
                    if ((_g = _this.debugConfiguration) === null || _g === void 0 ? void 0 : _g.loggerError) {
                        (_h = _this.debugConfiguration) === null || _h === void 0 ? void 0 : _h.loggerError("Failed to remove ".concat(removeCount, " reports. Existing reports: ").concat(_this.reportsStorage.getReportsCount()));
                    }
            ...
            if (reportsCount > _this.configuration.maxReportsCountInStorage) {
                ...
                if (tryToFreeSpaceSuccess) {
                    if ((_l = _this.debugConfiguration) === null || _l === void 0 ? void 0 : _l.loggerWarn) {
                        (_m = _this.debugConfiguration) === null || _m === void 0 ? void 0 : _m.loggerWarn("Number of reports removed: ".concat(removeCount, ". Actual reports: ").concat(_this.reportsStorage.getReportsCount()));
                    }
                }
                else {
                    if ((_o = _this.debugConfiguration) === null || _o === void 0 ? void 0 : _o.loggerError) {
                        (_p = _this.debugConfiguration) === null || _p === void 0 ? void 0 : _p.loggerError("Failed to remove ".concat(removeCount, " reports. Existing reports: ").concat(_this.reportsStorage.getReportsCount()));
                    }
                }
            }
        };
        ...
        var storeNamespace = "ug-ic".concat(apiKey, ".").concat(this.clientPrincipal.toText(), ".reportsStorage");
        ...
        log("ReportStorage created with namespace \"".concat(storeNamespace, "\", sequence = ").concat(this.sequence, ", unsent reports in storage = ").concat(this.reportsStorage.getReportsCount()));
    }
            ...
            return __generator(this, function (_a) {
                try {
                    if (analyticsReceiverApiResult) {
                        ...
                        return [2 /*return*/, createOkResult("ok")];
                    }
                    warn("Tracker.upload: analyticsReceiverApiResult is undefined. upload skipped");
                    return [2 /*return*/, createErrResult(new Error("AnalyticsStore unavailable."))];
                }
                catch (e) {
                    warn("Tracker.upload", e);
                    return [2 /*return*/, createErrResult(e)];
                }
                return [2 /*return*/];
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if ((_a = this.debugConfiguration) === null || _a === void 0 ? void 0 : _a.loggerLog) {
                            (_b = this.debugConfiguration) === null || _b === void 0 ? void 0 : _b.loggerLog("Will send packet", UsergeekUtils.jsonStringifyWithBigInt({ packet: uploadReportsData }));
                        }
    ...
    Tracker.prototype.handleUploadReportsResult = function (uploadEventPacketResult, maxSequence) {
        ...
        if (isOk(uploadEventPacketResult)) {
            ...
            if ((_c = this.debugConfiguration) === null || _c === void 0 ? void 0 : _c.loggerWarn) {
                (_d = this.debugConfiguration) === null || _d === void 0 ? void 0 : _d.loggerWarn("Packet send failed", UsergeekUtils.jsonStringifyWithBigInt({ result: uploadEventPacketResult }));
            }
            this.scheduleUploadReports();
        }
    };
