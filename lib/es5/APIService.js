...
import { createErrFatal, createOkResult, delayPromise, isErr, isOk, log, warn } from "./utils";
import { AnalyticsStoreApi } from "./AnalyticsStoreApi";
export var timeoutBetweenRetriesSec = 2;
var GLOBAL_RETRIES = 20;
export var COORDINATOR_RETRIES = 20;
export var CLIENT_REGISTRY_RETRIES = 20;
export var ANALYTICS_STORE_RETRIES = 20;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        warn("APIService.getAnalyticsReceiverApi getAnalyticsReceiverApiRecursively() error", e_1);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, createErrFatal()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.coordinatorApi.callCoordinatorRecursively(apiParameters, COORDINATOR_RETRIES)];
                    case 1:
                        ...
                        if (!isOk(coordinatorResponse)) return [3 /*break*/, 16];
                        okResponse = coordinatorResponse.ok;
                        if (!isClientRegistry(okResponse)) return [3 /*break*/, 14];
                        ...
                        return [4 /*yield*/, this.clientRegistryApi.callClientRegistryRecursively(clientRegistryApiParameters, CLIENT_REGISTRY_RETRIES)];
                    case 2:
                        ...
                        if (!isOk(clientRegistryResponse)) return [3 /*break*/, 4];
                        ...
                        return [4 /*yield*/, this.analyticsStoreApi.getAnalyticsReceiverApiRecursively(analyticsStoreApiParameters, ANALYTICS_STORE_RETRIES)];
                    case 3:
                        ...
                        return [3 /*break*/, 11];
                    case 4:
                        if (!isErr(clientRegistryResponse)) return [3 /*break*/, 11];
                    ...
                    case 5:
                        ...
                        timeout = getTimeout(GLOBAL_RETRIES - retriesLeft);
                    ...
                    case 14:
                        if (!isAnalyticsReceiver(okResponse)) return [3 /*break*/, 16];
                    ...
                    case 17:
                        ...
                        _b.label = 18;
                    case 18: return [2 /*return*/, createErrFatal()];
                }
            });
        });
    };
...
export { APIService };
export var getTimeout = function (retryIndex) {
