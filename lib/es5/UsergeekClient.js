...
var UsergeekClient = /** @class */ (function () {
    function UsergeekClient() {
        ...
        this.init = function (config) {
            ...
            _this.config = config;
            try {
                log("Usergeek: initialized with config: ".concat(JSON.stringify(config)));
            }
            catch (e) {
            }
        };
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            ...
                            warn("UsergeekClient.trackSession", e_1);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            ...
                            warn("UsergeekClient.trackEvent", e_2);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        this.validateAndPrepareEventTracker = function () {
            ...
            if (!_this.tracker) {
                _this.tracker = new Tracker(_this.config.apiKey, _this.clientPrincipal, _this.config.eventTrackerConfiguration, _this.config.debugConfiguration);
            }
        };
        ...
        this.tryToUploadPendingPackets = function () {
            ...
            if (apiParametersValid) {
                ...
                warn("UsergeekClient.tryToUploadPendingPackets: Please pass valid apiKey and non anonymous Principal.", { apiKey: (_e = _this.config) === null || _e === void 0 ? void 0 : _e.apiKey, clientPrincipal: _this.clientPrincipal });
            }
        };
        ...
        this.getAnalyticsReceiverApi = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_4 = _a.sent();
                        warn("UsergeekClient.getAnalyticsReceiverApi", e_4);
                        return [2 /*return*/, undefined];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        this.destroy = function () {
            ...
            if (_this.tracker) {
                ...
                warn("UsergeekClient.setPrincipal: existing Tracker destroyed", { clientPrincipal: _this.clientPrincipal });
            }
