...
var createActor = function (canisterId, options) {
    var agent = new HttpAgent(__assign({}, options === null || options === void 0 ? void 0 : options.agentOptions));
    ...
    return Actor.createActor(idlFactory, __assign({ agent: agent, canisterId: canisterId }, options === null || options === void 0 ? void 0 : options.actorOptions));
};
/**
 *
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("src/canisters/clientRegistry.did.d.ts")._SERVICE>}
 */
export var createCanisterActor = function (canisterId, identity, host) {
